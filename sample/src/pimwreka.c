...

{
  ...
  struct timeval mTime1, mTime2;
  clock_t clock1, clock2;
	
  /* This cause the process to stay on the first cpu */
  ...
  printf("temps %d clock %d\n",(mTime2.tv_sec - mTime1.tv_sec), (clock2 - clock1)/CLOCKS_PER_SEC); /* BUG: for more accuracy, %f instead of %d */
}
...
char *
bas2 (b, p, n)			/* AFFICHE LES CHIFFRES BINAIRES DE b PAR BLOC DE n CHIFFRES */
     TypInt b, p;
     int n;
